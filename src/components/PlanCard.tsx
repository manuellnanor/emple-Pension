...
export default function PlanCard({ plan, index, onSelect }: PlanCardProps) {
  return (
    <motion.div
      ...
      className="flex flex-col md:flex-row w-full bg-white overflow-hidden border border-[#f1f1f1] shadow-xs hover:shadow-md transition-shadow duration-300 cursor-pointer group"
    >
