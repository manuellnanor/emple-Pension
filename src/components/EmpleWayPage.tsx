...
import { PENSION_BOARD_MEMBERS, PENSION_MANAGEMENT_MEMBERS } from "../pensionLeadership";
...
export default function EmpleWayPage({ onContactClick }: EmpleWayPageProps) {
  ...
  return (
    <div className="bg-[#fafbfb] min-h-screen font-sans">
      ...
      <section className="bg-[#052e16] text-white py-16 md:py-24 dark-bg">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Our Mission Card */}
            <div className="bg-[#021f0f] p-8 sm:p-10 flex flex-col justify-between transition-all duration-300 hover:translate-y-[-4px] dark-bg">
              <div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 md:py-24">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="bg-[#32B44A] text-white p-8 sm:p-10 flex flex-col justify-end min-h-[220px] shadow-sm transform hover:scale-[1.01] transition-transform">
            ...
            {/* Innovation */}
            <div className="bg-white border border-[#f1f1f1] p-8 hover:shadow-md transition-all duration-300">
      ...
      <section className="bg-white py-20 md:py-24 border-t border-b border-[#f1f1f1]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-12 max-w-2xl">
            ...
            <h2 className="text-[34px] sm:text-[44px] font-bold text-gray-900 tracking-tight font-display mt-2">
              Board Of Directors
            </h2>
            <p className="text-gray-500 text-base leading-relaxed mt-3 font-sans">
              Meet the experienced leaders guiding emPLE Pensions’ strategy, governance, and commitment to dependable retirement solutions.
            </p>
          </div>

          {/* Grid Layout of Directors */}
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            {PENSION_BOARD_MEMBERS.map((member, idx) => (
              <motion.div 
                key={idx}
                whileHover={{ y: -5 }}
                className="bg-[#fafbfb] border border-[#f1f1f1] overflow-hidden shadow-sm hover:shadow-md group transition-all duration-300 flex flex-col h-full cursor-pointer"
              ...
              >
                ...
                <div className="p-5 flex-grow flex justify-between items-end border-t border-[#f1f1f1] bg-white">
                  <div className="space-y-1">
                    <h3 className="font-extrabold text-[16px] sm:text-[18px] text-gray-900 group-hover:text-emerald-700 transition-colors">
                      {member.name}
                    </h3>
      ...
      <section className="bg-[#052312] py-20 md:py-24 text-white font-sans dark-bg">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-12 max-w-2xl">
            ...
            <h2 className="text-[34px] sm:text-[44px] font-bold tracking-tight font-display mt-2 text-white">
              Management
            </h2>
            <p className="text-emerald-100/70 text-base leading-relaxed mt-3 max-w-xl">
              Meet the experienced pension leadership team guiding investment management, finance, technology, people, portfolio administration, and client service.
            </p>
          </div>

          {/* Grid Layout of Managers */}
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8">
            {PENSION_MANAGEMENT_MEMBERS.map((member, idx) => (
              <motion.div 
                key={idx}
                whileHover={{ scale: 1.02 }}
                className="bg-[#02180b] overflow-hidden relative group flex flex-col justify-end aspect-[4/5] h-full cursor-pointer shadow-md dark-bg"
                onClick={() => setSelectedLeader(member)}
              >
                ...
                <div className="relative z-10 p-4 m-3 sm:m-4 bg-[#055325] border-l-4 border-[#32B44A] text-white flex justify-between items-center group-hover:bg-[#037230] transition-colors">
                  <div className="space-y-0.5 pr-2">
                    <h3 className="font-extrabold text-[14px] sm:text-[15px] tracking-tight leading-tight">
                      {member.name}
                    </h3>
                    <p className="text-[12px] text-emerald-300 tracking-tight">
                      {member.role}
                    </p>
                  </div>
        ...
        {selectedLeader && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative w-full max-w-4xl md:max-w-5xl bg-white shadow-2xl overflow-y-auto max-h-[90vh] z-10 text-gray-800 scrollbar-thin"
            >
              <button
                onClick={() => setSelectedLeader(null)}
              ...
              <div className="flex flex-col md:flex-row items-stretch">
                ...
                <div className="w-full md:w-[58%] p-6 sm:p-8 md:p-12 lg:p-16 flex flex-col justify-center space-y-6">
                  ...
                  <div className="space-y-4 whitespace-pre-line text-gray-600 text-[12px] sm:text-[13px] leading-relaxed font-sans">
                    <p>
                      {selectedLeader.bio || `${selectedLeader.name} is part of the emPLE Life leadership team, helping guide the business with care, discipline, and commitment to customers.`}
                    </p>
                  </div>
                </div>
              </div>
