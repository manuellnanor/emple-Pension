...
export default function ClaimsPage({ onMakeClaim, onTrackClaim }: ClaimsPageProps) {
  // Modal state
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-start">
          ...
          <div className="lg:col-span-8 space-y-10">
            ...
            <motion.div
              ...
              className="relative bg-white overflow-hidden aspect-[16/10] sm:aspect-[21/11] border border-[#f1f1f1] shadow-sm"
            >
              <img
                src="/assets/images/claims-standing-with-you.png"
      ...
      <section className="bg-white py-16 border-t border-b border-[#f1f1f1]">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* Card 1: Make a Claim */}
            <div className="bg-[#fcfcfa]/90 border border-[#f1f1f1] p-8 sm:p-10 flex flex-col justify-between hover:shadow-md transition-shadow duration-300">
              <div className="space-y-6">
                <div>
                  <span className="text-[11px] font-bold text-gray-400 tracking-widest uppercase block mb-1">
                    EASE CLAIM
        ...
        {isClaimModalOpen && (
          <div className="fixed inset-0 z-50 overflow-y-auto flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="bg-white w-full max-w-lg shadow-2xl relative z-10 overflow-hidden border border-[#f1f1f1]"
            >
              {/* Header */}
              ...
              <div className="p-6 space-y-6">
                ...
                {trackingResult && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    className="border border-[#f1f1f1] overflow-hidden shadow-sm"
                  >
                    {/* Header info bar */}
                    ...
                    <div className="p-5 space-y-6">
                      ...
                      <div className="bg-emerald-50/40 p-3.5 border border-emerald-100/30 text-xs text-emerald-800 leading-relaxed font-sans space-y-1">
