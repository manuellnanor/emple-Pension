        ...
        {filteredBranches.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {filteredBranches.map((branch) => (
              <div 
                key={branch.name}
                className="group p-6 bg-white border border-gray-100 hover:shadow-xl transition-all duration-300 hover:bg-[#052e16] hover:border-transparent flex items-start gap-4 cursor-pointer [&:hover_h3]:!text-white"
              >
          ...
          <div className="text-center py-20 border border-dashed border-gray-100 bg-gray-50/50">
